    ...
    <div class="announcements-table">
        <b-table
            ...
            <template slot-scope="props">
                ...
                <b-table-column field="published_at" :label="trans('labels.announcements.published_at')" sortable>
                    {{ props.row.published_at | formatDateTime }}
                </b-table-column>

                <b-table-column field="expires_at" :label="trans('labels.announcements.expires_at')" sortable>
                    {{ props.row.expires_at | formatDateTime }}
                </b-table-column>
